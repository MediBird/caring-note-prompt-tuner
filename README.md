...
* 이번 분석 결과, 중재기록과 AI 요약 결과가 **유사도 기준 0.5 이상인 경우가 전체의 58.3%**에 해당했으며,
  ...
  이 중 일부는 약사가 AI 요약 결과를 직접 복사한 케이스도 존재함.
  이를 통해, **약사가 작성한 중재기록은 사용자가 의도한 요약 방향을 대변한다고 볼 수 있으며**,

  향후 프롬프트 평가/튜닝 시 중재기록을 **레퍼런스 요약(reference summary)**으로 활용하는 것이 타당함을 시사함.
